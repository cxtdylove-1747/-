...
class ContainerdEngine(BaseEngine):
    """containerd 引擎适配器（主要用于 CRI 场景的端点配置）"""
    ...
    async def create_container(self, image: str, name: Optional[str] = None,
        ...
        raise NotImplementedError("ContainerdEngine operations are executed via CRIExecutor (crictl)")
